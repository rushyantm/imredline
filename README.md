...
**The gallery** at `/imredline/clips` — cards with screenshot, swatches and fonts; filter by collection or site; open one for the README, the preview in a sandboxed iframe, and Copy prompt / HTML / CSS / tokens. Reviewers can browse; admins can also discard from the detail view.
